...
public class TwoColumnNetworkReader extends AbstractTask implements CyNetworkReader  {
//	reads the file and creates a CyNetwork.
	...
	public TwoColumnNetworkReader(InputStream stream, CyNetworkFactory networkFactory, CyNetworkViewFactory viewFactory) {
		this.stream = stream;
